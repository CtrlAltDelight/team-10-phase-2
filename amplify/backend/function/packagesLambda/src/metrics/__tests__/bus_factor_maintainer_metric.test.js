...
describe('fetchResponse', () => {
    ...
    */
    it('should handle fetch error', async () => {
        ...
        const contributors = await (0, bus_factor_maintainer_metric_2.fetchResponse)('https://example.com/api/contributors').catch((error) => {
            return null;
        });
...
describe('calcBusFactor', () => {
    it('should calculate bus factor correctly', async () => {
        ...
        const busFactor = await (0, bus_factor_maintainer_metric_2.calcBusFactor)(owner, repo);
...
describe('calcResponsiveMaintainer', () => {
    it('should calculate responsive maintainer correctly', async () => {
        const owner = "cloudinary";
        const repo = "cloudinary_npm";
        const responsiveMaintainer = await (0, bus_factor_maintainer_metric_2.calcResponsiveMaintainer)(owner, repo);
...
describe('bus_factor_maintainer_metric', () => {
    it('should return an array of metrics with GitHub Url', async () => {
        ...
        const metrics = await (0, bus_factor_maintainer_metric_1.bus_factor_maintainer_metric)(repoURL);
