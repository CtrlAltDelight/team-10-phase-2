...
async function processUrls(urlFile) {
    try {
        ...
        for (const url of urls) {
            ...
            l_r_metric_array = await (0, license_ramp_up_metric_1.license_ramp_up_metric)(url); //returns license metric first and then ramp up metric
            ...
            bf_rm_metric_array = await (0, bus_factor_maintainer_metric_1.bus_factor_maintainer_metric)(url);
