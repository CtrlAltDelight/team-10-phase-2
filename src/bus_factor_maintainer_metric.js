...
function calcDependenciesMetric(owner, repo) {
    return __awaiter(this, void 0, void 0, function* () {
        const packageJson = yield fetchPackageJson(owner, repo);
        if (!packageJson)
...
function fetchPullRequests(owner, repo, octokit) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const prs = yield octokit.paginate(octokit.pulls.list, {
                owner: owner,
                repo: repo,
...
function calcCodeReviewMetric(owner, repo) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try { // Getting all pull requests
            pullRequests = yield fetchPullRequests(owner, repo, octokit);
        }
        catch (error) {
            run_1.default.log({ 'level': 'error', 'message': `Error fetching pull requests: ${error}` });
            return 0;
        ...
        for (const pr of prData) {
            try {
                ...
                const info = yield octokit.pulls.get({
                    owner: owner,
                    repo: repo,
                    pull_number: pr.number
                });
...
function bus_factor_maintainer_metric(repoURL) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        dependencies = yield calcDependenciesMetric(sections[1], sections[2]);
        // Calculate code review metric. Added by Luke.
        code_review = yield calcCodeReviewMetric(sections[1], sections[2]);
